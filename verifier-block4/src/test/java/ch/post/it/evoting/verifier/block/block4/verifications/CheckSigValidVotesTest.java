...
class CheckSigValidVotesTest extends Block4VerificationAbstractTest {
    ...
    @BeforeEach
    void setup() {
        verification = new CheckSigValidVotes();
    }

    @Test
    void executeTestOK() throws Exception {
        VerificationResult verificationResult = new CheckSigValidVotes().verify(Paths.get(getClass().getResource("/CheckSigValidVotesTest" +
                "/OK").toURI()));
