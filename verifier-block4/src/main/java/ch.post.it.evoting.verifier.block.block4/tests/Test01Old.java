 ...
 * @version $$Revision$$
 */
public class Test01Old extends Test {

    private static final Logger log = Logger.getLogger(Test01Old.class);
    ...
    public TestResult executeTest(File inputDirectory) {
        ...
        try {
            ...
            Results decryptResult = Deserializer.fromXml(inputDirectory, "evoting-decrypt.xml", Results.class);
