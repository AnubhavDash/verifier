...
public class CheckSigInvalidVotes extends Verification {
    ...
    public VerificationDefinition getVerificationDefinition() {
        ...
        def.setDescription(TranslationHelper.getFromResourceBundle(Block4VerificationSuite.RESOURCE_BUNDLE_NAME, "test76.description"));
        def.setId(76);
    ...
    public VerificationResult executeVerification(File inputDirectory) {
        ...
        try {
            ...
            File[] sivFiles = PathHelper.getFiles(inputDirectory.toPath().resolve(Block4VerificationSuite.PATH_RESULTS).toFile(), "siv_(?!decryption).*\\.csv");
            ...
            result.setMessage(TranslationHelper.getFromResourceBundle(Block4VerificationSuite.RESOURCE_BUNDLE_NAME, "test76.nok.message"));
        } catch (NoSuchFileException e) {
            LOGGER.error("a NoSuchFileException error occurred", e);
            result.setStatus(Status.NOK);
            result.setMessage(TranslationHelper.getFromResourceBundle(Block4VerificationSuite.RESOURCE_BUNDLE_NAME, "test76.file.not.found.message", e.getFile()));
        } catch (Exception e) {
