...
public class IsMemberOfGroupPKEATest {
    ...
    public void executeTestOK() {
        VerificationResult verificationResult = new IsMemberOfGroupPKEA().executeVerification(new File(getClass().getResource("/IsMemberOfGroupPKEATest/OK").getFile()));
    ...
    public void executeTestNOK() {
        VerificationResult verificationResult = new IsMemberOfGroupPKEA().executeVerification(new File(getClass().getResource("/IsMemberOfGroupPKEATest/NOK/NOK").getFile()));
        Assert.assertNotNull(verificationResult);
