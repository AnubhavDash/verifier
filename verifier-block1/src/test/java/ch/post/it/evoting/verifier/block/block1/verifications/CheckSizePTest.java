...
class CheckSizePTest extends Block1VerificationAbstractTest {

	public CheckSizePTest() {
		super(CheckSizeP.class);
	}
	...
	void executeTestNOK() {
		...
		assertEquals("p does not have the right size", ex.getMessage());
	}
