...
class CheckSigEch015XTest extends Block1VerificationTest {
	...
	static void setUpAll() {
		verification = new CheckSigEch015X(pathService, certificateLoader, applicationEventPublisherMock);
	}
	...
	void executeTestNOKCertKo() throws URISyntaxException {
		...
		final var expectedResultEvent = VerificationResultEvent.failure(this, verification.getVerificationDefinition(),
				TranslationHelper.getFromResourceBundle(Block1VerificationSuite.RESOURCE_BUNDLE_NAME, "verification72.nok.message", fileName));
		assertEquals(expectedResultEvent, resultEvent);
	}
