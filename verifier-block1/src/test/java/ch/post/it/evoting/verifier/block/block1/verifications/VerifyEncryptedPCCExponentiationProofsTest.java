...
class VerifyEncryptedPCCExponentiationProofsTest extends Block1VerificationTest {
	...
	static void setUpAll() {
		...
		verification = new VerifyEncryptedPCCExponentiationProofs(new ExponentiationProofsVerificationService<>(dataExtractionService, pathService),
	...
	@ParameterizedTest
	@ValueSource(strings = {
			"/VerifyEncryptedPCCExponentiationProofs/wrong-proof/",
			"/VerifyEncryptedPCCExponentiationProofs/wrong-public-key/",
			"/VerifyEncryptedPCCExponentiationProofs/wrong-cipher-text/"
	})
