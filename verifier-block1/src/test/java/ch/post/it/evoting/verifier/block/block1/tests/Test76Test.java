...
public class Test76Test {

    @Test
    public void executeTestOK() {
        TestResult testResult = new Test76().executeTest(new File(getClass().getResource("/Test76/OK").getFile()));
    ...
    public void executeTestNOKCertKo() {
        TestResult testResult = new Test76().executeTest(new File(getClass().getResource("/Test76/NOK/CERT-NOT-OK").getFile()));
        Assert.assertNotNull(testResult);
    ...
    public void executeTestNOKjsonKo() {
        TestResult testResult = new Test76().executeTest(new File(getClass().getResource("/Test76/NOK/JSON-NOT-OK").getFile()));
        Assert.assertNotNull(testResult);
        Assert.assertEquals(Status.NOK, testResult.getStatus());
    }
