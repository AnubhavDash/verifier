...
public class IsQuadraticResidueVO extends Verification {
    ...
    public VerificationDefinition getVerificationDefinition() {
        ...
        def.setDescription(TranslationHelper.getFromResourceBundle(Block1VerificationSuite.RESOURCE_BUNDLE_NAME, "test06.description"));
        def.setId(6);
    ...
    public VerificationResult executeVerification(File inputDirectory) {
        ...
        try {
            ...
            if (errors.isEmpty()) {
                ...
                result.setMessage(TranslationHelper.getFromResourceBundle(Block1VerificationSuite.RESOURCE_BUNDLE_NAME, "test06.nok.message", errors.toString()));
            }
        } catch (FileNotFoundException e) {
            LOGGER.error("a FileNotFoundException error occurred", e);
            result.setStatus(Status.NOK);
            result.setMessage(TranslationHelper.getFromResourceBundle(Block1VerificationSuite.RESOURCE_BUNDLE_NAME, "test06.file.not.found.message"));
        } catch (Exception e) {
