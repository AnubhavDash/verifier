...
public class IsPrimeVO extends AbstractVerification {
	...
	public IsPrimeVO(final PathService pathService, final ApplicationEventPublisher applicationEventPublisher) {
	...
	public VerificationResultEvent verify(final VerifierEvent event) {
		...
		if (!errors.isEmpty()) {
			return VerificationResultEvent.failure(this, getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(Block1VerificationSuite.RESOURCE_BUNDLE_NAME, "verification05.nok.message",
							errors.toString()));
		}
