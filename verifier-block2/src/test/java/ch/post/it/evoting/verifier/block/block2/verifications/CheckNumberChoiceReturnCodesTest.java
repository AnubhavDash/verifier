...
class CheckNumberChoiceReturnCodesTest extends Block2VerificationAbstractTest {

	public CheckNumberChoiceReturnCodesTest() {
		super(CheckNumberChoiceReturnCodes.class);
	}

	@Test
	@Disabled("Enable when we got secureLog files with correct pattern.")
	void executeTestOK() throws Exception {
		VerificationResult verificationResult = verification.verify(Paths.get(getClass().getResource("/CheckNumberChoiceReturnCodesTest" +
				"/OK").toURI()));
