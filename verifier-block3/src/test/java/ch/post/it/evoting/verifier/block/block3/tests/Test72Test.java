...
public class Test72Test {
    ...
    public void executeTestNOKCsvKo() {
        TestResult testResult = new Test72().executeTest(new File(getClass().getResource("/Test72/NOK/CSV-NOT-OK").getFile()));
        Assert.assertNotNull(testResult);
    ...
    public void executeTestNOKFileNotFound() {
        TestResult testResult = new Test72().executeTest(new File(getClass().getResource("/Test72/NOK-NOTFILE").getFile()));
        Assert.assertNotNull(testResult);
        Assert.assertEquals(Status.NOK, testResult.getStatus());
    }
}