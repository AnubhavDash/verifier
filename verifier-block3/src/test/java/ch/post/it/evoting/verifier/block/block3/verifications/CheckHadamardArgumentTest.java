...
class CheckHadamardArgumentTest extends Block3VerificationAbstractTest {

	public CheckHadamardArgumentTest() {
		super(CheckHadamardArgument.class);
	}
	...
	void executeTestKOFileNotFound() {
		final NoSuchFileException ex = assertThrows(
				...
				() -> verification.verify(Paths.get(getClass().getResource("/CheckHadamardArgumentTest/NOK-NOTFILE").toURI()))
		);
