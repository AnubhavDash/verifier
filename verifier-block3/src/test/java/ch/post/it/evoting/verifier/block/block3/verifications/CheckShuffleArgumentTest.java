...
class CheckShuffleArgumentTest extends Block3VerificationAbstractTest {

	public CheckShuffleArgumentTest() {
		super(CheckShuffleArgument.class);
	}
	...
	void executeTestKOFileNotFound() {
		final NoSuchFileException ex = assertThrows(
				...
				() -> verification.verify(Paths.get(getClass().getResource("/CheckShuffleArgumentTest/NOK-NOTFILE").toURI()))
		);
