...
public interface ShuffleArgumentSecondAnswerMapper {
    ...
    default ShuffleProofSecondAnswer map(ShuffleArgumentSecondAnswer source) {
        MultiExponentiationBasicProofInitialMessage iniMEBasic = MultiExponentiationArgumentMapper.INSTANCE.mapInitMessage(source.getMultiExponentiationArgumentInitMessage());
        MultiExponentiationBasicProofAnswer ansMEBasic = MultiExponentiationArgumentMapper.INSTANCE.mapAnswer(source.getMultiExponentiationArgumentAnswer());
