...
public class Test26 extends Test {
    ...
    private static final Logger LOGGER = Logger.getLogger(Test26.class);
    ...
    public TestDefinition getTestDefinition() {
        ...
        testDefinition.setId(26);
        testDefinition.setName("checkMultiExponentationArgument");
        testDefinition.setDescription(TranslationHelper.getFromResourceBundle(Block3TestSuite.RESOURCE_BUNDLE_NAME, "test06.description"));
    ...
    public TestResult executeTest(File inputDirectory) {
        ...
        try {
            ...
            AbstractMap.SimpleEntry<Status, String> status = processor.getStatus(BGVerificationProcessor.TestType.MultiExponentiationProof);
