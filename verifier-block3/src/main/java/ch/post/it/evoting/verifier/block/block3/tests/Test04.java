...
public class Test04 extends Test {
    ...
    public TestDefinition getTestDefinition() {
        ...
        testDefinition.setId(4);
        testDefinition.setName("checkZeroArgument");
        testDefinition.setDescription(TranslationHelper.getFromResourceBundle(Block3TestSuite.RESOURCE_BUNDLE_NAME, "test04.description"));
