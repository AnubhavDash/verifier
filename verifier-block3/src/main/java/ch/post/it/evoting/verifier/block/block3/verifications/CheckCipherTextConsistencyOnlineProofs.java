...
public class CheckCipherTextConsistencyOnlineProofs extends AbstractVerification {
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		verificationDefinition
				.setDescription(TranslationHelper.getFromResourceBundle(Block3VerificationSuite.RESOURCE_BUNDLE_NAME, "verification31.description"));
	...
	public VerificationResult verify(Path inputDirectoryPath) throws Exception {
		...
		for (Path ballotBoxIdDirectoryPath : ballotBoxIdDirectoriesPathNode.getRegexPaths()) {
			...
			// Downloaded ballot
			PathNode downloadedBallotBoxPathNode = pathService
					.buildFromDynamicAncestorPath(StructureKey.DOWNLOADED_BALLOT_BOX, ballotBoxIdDirectoryPath);
	...
	static class GammaPhis {
		...
		private final List<String> phis;
