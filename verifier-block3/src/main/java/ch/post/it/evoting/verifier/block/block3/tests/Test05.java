...
public class Test05 extends Test {
    ...
    public TestDefinition getTestDefinition() {
        ...
        testDefinition.setId(5);
        testDefinition.setName("checkSingleValueProductArgument");
        testDefinition.setDescription(TranslationHelper.getFromResourceBundle(Block3TestSuite.RESOURCE_BUNDLE_NAME, "test05.description"));
