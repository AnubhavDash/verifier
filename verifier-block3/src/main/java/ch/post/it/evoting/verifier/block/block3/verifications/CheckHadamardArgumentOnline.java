...
public class CheckHadamardArgumentOnline extends AbstractVerification {

    private static final Logger LOGGER = Logger.getLogger(CheckHadamardArgumentOnline.class);
