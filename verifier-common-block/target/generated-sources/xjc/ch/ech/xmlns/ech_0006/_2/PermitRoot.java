...
public class PermitRoot {
    ...
    public PermitRoot withResidencePermitCategory(String value) {
        setResidencePermitCategory(value);
        return this;
    }

    public PermitRoot withResidencePermitRuling(String value) {
        setResidencePermitRuling(value);
        return this;
    }

    public PermitRoot withResidencePermitBorder(String value) {
        setResidencePermitBorder(value);
        return this;
    }

    public PermitRoot withResidencePermitShortType(String value) {
        setResidencePermitShortType(value);
        return this;
    }

    public PermitRoot withResidencePermit(String value) {
        setResidencePermit(value);
        return this;
    }

    public PermitRoot withInhabitantControl(String value) {
        setInhabitantControl(value);
        return this;
    }

    public PermitRoot withResidencePermitDetailedType(String value) {
        setResidencePermitDetailedType(value);
        return this;
    }

    public PermitRoot withResidencePermitToBeRegisteredType(String value) {
        setResidencePermitToBeRegisteredType(value);
        return this;
    }
