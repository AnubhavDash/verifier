...
/**
 * <p>Java class for votingPersonIdentificationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="votingPersonIdentificationType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="otherPersonId" type="{http://www.ech.ch/xmlns/eCH-0044/4}namedPersonIdType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="officialName" type="{http://www.ech.ch/xmlns/eCH-0044/4}baseNameType" minOccurs="0"/&gt;
...
@XmlType(name = "votingPersonIdentificationType", propOrder = {
    "vn",
    "localPersonId",
    "otherPersonId",
    "officialName",
...
public class VotingPersonIdentificationType {
    ...
    public VotingPersonIdentificationType withVn(Long value) {
        setVn(value);
        return this;
    }

    public VotingPersonIdentificationType withLocalPersonId(NamedPersonIdType value) {
        setLocalPersonId(value);
        return this;
    }

    public VotingPersonIdentificationType withOtherPersonId(NamedPersonIdType... values) {
        if (values!= null) {
    ...
    public VotingPersonIdentificationType withOtherPersonId(Collection<NamedPersonIdType> values) {
        if (values!= null) {
    ...
    public VotingPersonIdentificationType withOfficialName(String value) {
        setOfficialName(value);
        return this;
    }

    public VotingPersonIdentificationType withFirstName(String value) {
        setFirstName(value);
        return this;
    }

    public VotingPersonIdentificationType withSex(String value) {
        setSex(value);
        return this;
    }

    public VotingPersonIdentificationType withDateOfBirth(DatePartiallyKnownType value) {
