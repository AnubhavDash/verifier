...
public class ShuffleArgumentSecondAnswer {
	...
	public ShuffleArgumentSecondAnswer(
			@JsonProperty("msgPA")
					ProductArgumentMessage msgPA,
			@JsonProperty("iniMEBasic")
					MultiExponentiationArgumentInitMessage iniMEBasic,
			@JsonProperty("ansMEBasic")
					MultiExponentiationArgumentAnswer ansMEBasic) {
