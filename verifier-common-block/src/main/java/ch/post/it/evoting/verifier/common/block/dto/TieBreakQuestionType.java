 ...
 *         &lt;element name="questionPosition" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "tieBreakQuestionType", namespace = "http://www.evoting.ch/xmlns/config/3", propOrder = {
...
public class TieBreakQuestionType {
    ...
    @XmlElement(namespace = "http://www.evoting.ch/xmlns/config/3", required = true)
    protected String questionPosition;
    @XmlElement(namespace = "http://www.evoting.ch/xmlns/config/3", required = true)
     ...
     *     
     */
    public void setQuestionPosition(String value) {
