...
public class Vote {
    ...
    public final List<BigInteger> partialEncryptedChoiceCodes;
    ...
    @JsonCreator
    public Vote(@JsonProperty("electionEventId") UUID electionEventId, @JsonProperty("ballotId") UUID ballotId,
                ...
                @JsonProperty("partialEncryptedChoiceCodes") List<BigInteger> partialEncryptedChoiceCodes,
        ...
        this.partialEncryptedChoiceCodes = partialEncryptedChoiceCodes;
