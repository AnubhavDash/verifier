...
/**
 * Consumer that allows to work with streams without having to to introduce try-catch blocks for checked exceptions. This consumer wraps
 * every exception in a {@link VerificationFailureWrappedException} except the {@link VerificationFailureException}.
 *
