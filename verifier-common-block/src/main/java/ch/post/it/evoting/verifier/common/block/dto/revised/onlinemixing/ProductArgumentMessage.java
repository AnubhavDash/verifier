...
public class ProductArgumentMessage {
	...
	public ProductArgumentMessage(
			@JsonProperty("commitmentPublicB")
					Commitment commitmentPublicB,
			@JsonProperty("iniSVA")
					SingleValueArgumentInitMessage iniSVA,
			@JsonProperty("ansSVA")
					SingleValueArgumentAnswer ansSVA,
			@JsonProperty("iniHPA")
					HadamardProductArgumentInitMessage iniHPA,
			@JsonProperty("ansHPA")
					HadamardProductArgumentAnswer ansHPA) {
