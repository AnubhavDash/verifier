...
@Component
public class CheckSignatureEncryptedCodeShares extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureEncryptedCodeShares(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setId(94);
		definition.setName("checkSignatureEncryptedCodeShares");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		if (verified) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME,
							"verification.direct.trust.signature.fail", "ControlComponentCodeShares"));
		}

	}

	@VisibleForTesting
	boolean verifySignature(final ControlComponentCodeSharesPayload controlComponentCodeSharesPayload) {
