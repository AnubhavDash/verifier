...
public class VerifyOnlineControlComponentsContext {
	...
	public VerifyOnlineControlComponentsContext(final ElectionEventContextPayload electionEventContextPayload,
	...
	public GqGroup getEncryptionGroup() {
		...
		return electionEventContext.verificationCardSetContexts().get(0).getPrimesMappingTable().getEncryptionGroup();
	}
}
