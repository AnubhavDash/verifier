 ...
 */
@Component
public class VerifyBallotBoxesConsistency extends AbstractVerification {

	private final PathService pathService;
	private final ElectionDataExtractionService electionDataExtractionService;

	protected VerifyBallotBoxesConsistency(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME, "tally.verification38.description"));
		definition.setId(38);
		definition.setName("verifyBallotBoxesConsistency");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		if (sameBallotBoxIds) {
			...
			verificationResult = VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME, "tally.verification38.nok.message"));
		}
