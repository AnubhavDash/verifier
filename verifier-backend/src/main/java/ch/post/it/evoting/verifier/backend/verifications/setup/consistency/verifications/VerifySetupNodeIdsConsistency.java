...
@Component
public class VerifySetupNodeIdsConsistency extends AbstractVerification {

	private final ElectionDataExtractionService extractionService;

	protected VerifySetupNodeIdsConsistency(final ApplicationEventPublisher applicationEventPublisher,
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification05.description"));
		definition.setId(5);
	...
	public VerificationResult verify(Path inputDirectoryPath) {
		...
		if (verifyNodeIdsConsistency(publicKeysNodeIds, codeSharesNodeIds)) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification05.nok.message"));
		}
	}
