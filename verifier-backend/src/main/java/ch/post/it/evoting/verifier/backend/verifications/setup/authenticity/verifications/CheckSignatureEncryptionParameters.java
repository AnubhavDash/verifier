...
@Component
public class CheckSignatureEncryptionParameters extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureEncryptionParameters(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setId(90);
		definition.setName("checkSignatureEncryptionParameters");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		boolean verified = verifySignature(encryptionParametersPayload);
