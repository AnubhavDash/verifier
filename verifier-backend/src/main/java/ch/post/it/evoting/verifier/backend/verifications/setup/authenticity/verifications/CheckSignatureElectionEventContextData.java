...
@Component
public class CheckSignatureElectionEventContextData extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureElectionEventContextData(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setId(91);
		definition.setName("checkSignatureElectionEventContextData");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		boolean verified = verifySignature(electionEventContextPayload);
