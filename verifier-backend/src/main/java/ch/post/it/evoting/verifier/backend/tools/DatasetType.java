...
public enum DatasetType {
	...
	TALLY(List.of(StructureKey.TALLY_COMPONENT_ECH0222, StructureKey.CONTROL_COMPONENT_BALLOT_BOX, StructureKey.CONTROL_COMPONENT_SHUFFLE,
			StructureKey.TALLY_COMPONENT_SHUFFLE, StructureKey.TALLY_COMPONENT_VOTES));
