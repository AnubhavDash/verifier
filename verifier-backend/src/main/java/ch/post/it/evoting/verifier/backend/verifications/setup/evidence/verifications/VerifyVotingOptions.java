...
import ch.post.it.evoting.verifier.backend.verifications.setup.evidence.algorithms.VerifyVotingOptionsAlgorithm;
...
public class VerifyVotingOptions extends AbstractVerification {
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME,
				"setup.verification03.description"));
		definition.setId(3);
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		if (verifyVotingOptionsAlgorithm.verifyVotingOptions(smallPrimeGroupMembers, encodedVotingOptions)) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification03.nok.message"));
		}
	}
