...
public class VerifyElectionEventIdConsistency extends AbstractVerification {
    ...
    public VerificationDefinition getVerificationDefinition() {
        ...
        definition.setDescription(
                TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification41.description"));
        definition.setId(41);
        definition.setName(VerifyElectionEventIdConsistency.class.getSimpleName());
    ...
    public VerificationResult verify(final Path inputDirectoryPath) {
        ...
        if (sameElectionEventId) {
            ...
            return VerificationResult.failure(getVerificationDefinition(),
                    TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification41.nok.message"));
        }
    }
