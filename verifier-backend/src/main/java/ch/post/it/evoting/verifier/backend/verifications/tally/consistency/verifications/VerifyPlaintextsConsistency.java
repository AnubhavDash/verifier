...
public class VerifyPlaintextsConsistency extends AbstractVerification {
	...
	protected VerifyPlaintextsConsistency(final ApplicationEventPublisher applicationEventPublisher,
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME,
				"tally.verification44.description"));
		definition.setId(44);
	...
	public VerificationResult verify(Path inputDirectoryPath) {
		...
		if (plaintextsConsistent(plaintexts)) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME, "tally.verification44.nok.message"));
		}
	}
