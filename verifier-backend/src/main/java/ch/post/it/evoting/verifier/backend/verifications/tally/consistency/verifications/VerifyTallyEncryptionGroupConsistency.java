...
@Component
public class VerifyTallyEncryptionGroupConsistency extends AbstractVerification {

	private final EncryptionGroupParametersExtractionService extractionService;

	public VerifyTallyEncryptionGroupConsistency(final ApplicationEventPublisher applicationEventPublisher,
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME, "tally.verification30.description"));
		definition.setId(30);
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		final Stream<EncryptionGroupParameters> allGroupParameters = Streams.concat(
				...
				Stream.of(extractionService.getFromTallyComponentShufflePayload(inputDirectoryPath)),
				Stream.of(extractionService.getFromTallyComponentVotesPayload(inputDirectoryPath))
		);
