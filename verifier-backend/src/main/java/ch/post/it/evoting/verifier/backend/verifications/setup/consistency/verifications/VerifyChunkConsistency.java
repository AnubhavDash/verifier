...
public class VerifyChunkConsistency extends AbstractVerification {
    ...
    public VerificationDefinition getVerificationDefinition() {
        ...
        definition.setDescription(
                TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification40.description"));
        definition.setId(40);
        definition.setName(VerifyChunkConsistency.class.getSimpleName());
