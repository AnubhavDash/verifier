...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.AnswerInformationType;
...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.AuthorizationsType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.BallotDescriptionInformationType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.BallotQuestionType;
...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.CandidateTextInformationType;
...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ContestDescriptionInformationType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ContestType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.CountingCircleType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.DomainOfInfluenceType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.DwellingAddressType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ElectionDescriptionInformationType;
...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ElectoralAuthorityMembersType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ElectoralAuthorityType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ElectronicAddressType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ExtendedAuthenticationKeyType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ExtendedAuthenticationKeysDefinitionType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ExtendedAuthenticationKeysType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.HeaderType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.IncumbentTextInfoType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.IncumbentTextType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.IncumbentType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.LanguageType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ListDescriptionInformationType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ListType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ListUnionDescriptionType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ListUnionType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.OccupationalTitleInformationType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.PartyAffiliationformationType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.PersonType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.PhysicalAddressType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.PropertyType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.ReferencedElectionInformationType;
...
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.UiPropertiesType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.VarListTextInfoType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.VarListTextType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.VariantBallotType;
import ch.post.it.verifier.backend.domain.xmlns.evotingconfig.VoteDescriptionInformationType;
...
public interface HashableContestConfigurationFactory {
	...
	private static Hashable fromDwellingAddress(final DwellingAddressType dwellingAddress) {
		...
		final boolean hasSwissZipCode = dwellingAddress.getSwissZipCode() != null;
		if (hasSwissZipCode) {
