...
@Component
public class CheckSignatureOnlineCCKeys extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureOnlineCCKeys(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setName("CheckSignatureOnlineCCKeys");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		final var controlComponentPublicKeysPayloads = electionDataExtractionService.getControlComponentPublicKeysPayloads(
				inputDirectoryPath);
