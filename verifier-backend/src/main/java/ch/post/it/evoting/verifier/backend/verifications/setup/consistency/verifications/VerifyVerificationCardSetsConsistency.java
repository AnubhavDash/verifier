 ...
 */
@Component
public class VerifyVerificationCardSetsConsistency extends AbstractVerification {

	private final PathService pathService;
	private final ElectionDataExtractionService electionDataExtractionService;

	protected VerifyVerificationCardSetsConsistency(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification37.description"));
		definition.setId(37);
		definition.setName("verifyVerificationCardSetsConsistency");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		if (sameVerificationCardSetIds) {
			...
			verificationResult = VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification37.nok.message"));
		}
