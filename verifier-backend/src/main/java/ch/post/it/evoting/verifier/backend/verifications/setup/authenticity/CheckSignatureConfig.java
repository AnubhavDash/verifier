...
@Component
public class CheckSignatureConfig extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureConfig(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setName("CheckSignatureConfig");
	...
	boolean verifySignature(final Configuration configuration) {
		...
		checkState(signature != null, "The signature of the configuration file is null.");
		...
		try {
			...
			throw new IllegalStateException("Could not verify the signature of the configuration file.");
		}
	}
}
