...
public class VerifyVerificationCardSetIdsConsistency extends AbstractVerification {
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification39.description"));
		definition.setId(39);
	...
	public VerificationResult verify(Path inputDirectoryPath) {
		...
		if (sameVerificationCardSetIds) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification39.nok.message"));
		}
	}
