...
public class VerifyPrimesMappingTableConsistency extends AbstractVerification {
	...
	private ElectionDataExtractionService extractionService;
	private VerifyPrimesMappingTableConsistencyAlgorithm consistencyAlgorithm;
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME, "setup.verification36.description"));
		definition.setId(36);
