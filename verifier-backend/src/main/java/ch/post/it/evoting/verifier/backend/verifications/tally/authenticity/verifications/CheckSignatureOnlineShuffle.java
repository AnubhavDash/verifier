...
@Component
public class CheckSignatureOnlineShuffle extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureOnlineShuffle(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setId(92);
		definition.setName("checkSignatureOnlineShuffle");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		final var controlComponentShufflePayloads = electionDataExtractionService.getControlComponentShufflePayloads(inputDirectoryPath);
		...
		if (verified) {
			...
			return VerificationResult.failure(getVerificationDefinition(),
					TranslationHelper.getFromResourceBundle(SetupVerificationSuite.RESOURCE_BUNDLE_NAME,
							"verification.direct.trust.signature.fail", "ControlComponentShuffle"));
		}
