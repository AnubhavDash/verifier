 ...
 */
package ch.post.it.evoting.verifier.backend.verifications.tally.completeness.verifications;
...
public class VerifyTallyCompleteness extends AbstractVerification {
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setDescription(
				TranslationHelper.getFromResourceBundle(TallyVerificationSuite.RESOURCE_BUNDLE_NAME, "verification00.description"));
		definition.setId(0);
		definition.setName("VerifyTallyCompleteness");
		definition.addVerifierEvent(PreDecryptionEvent.TYPE);
		return definition;
	}
