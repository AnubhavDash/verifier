...
@XmlType(name = "standardQuestionType", propOrder = {
...
public class StandardQuestionType {
    ...
    public StandardQuestionType withQuestionIdentification(String value) {
        setQuestionIdentification(value);
        return this;
    }

    public StandardQuestionType withQuestionPosition(BigInteger value) {
        setQuestionPosition(value);
        return this;
    }

    public StandardQuestionType withQuestionNumber(String value) {
        setQuestionNumber(value);
        return this;
    }

    public StandardQuestionType withAnswerType(BigInteger value) {
        setAnswerType(value);
        return this;
    }

    public StandardQuestionType withBallotQuestion(BallotQuestionType value) {
        setBallotQuestion(value);
        return this;
    }

    public StandardQuestionType withAnswer(StandardAnswerType... values) {
        if (values!= null) {
    ...
    public StandardQuestionType withAnswer(Collection<StandardAnswerType> values) {
        if (values!= null) {
