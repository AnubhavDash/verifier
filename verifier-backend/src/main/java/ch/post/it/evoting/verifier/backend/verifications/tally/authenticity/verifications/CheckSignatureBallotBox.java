...
@Component
public class CheckSignatureBallotBox extends AbstractVerification {

	private final ElectionDataExtractionService electionDataExtractionService;

	private final SignatureVerification signatureVerification;

	protected CheckSignatureBallotBox(
	...
	public VerificationDefinition getVerificationDefinition() {
		...
		definition.setId(91);
		definition.setName("checkSignatureBallotBox");
	...
	public VerificationResult verify(final Path inputDirectoryPath) {
		...
		final var controlComponentBallotBoxPayloads = electionDataExtractionService.getControlComponentBallotBoxPayloads(inputDirectoryPath);
