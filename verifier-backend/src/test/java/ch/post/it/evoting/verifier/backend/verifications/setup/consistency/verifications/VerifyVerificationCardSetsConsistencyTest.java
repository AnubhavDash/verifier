...
class VerifyVerificationCardSetsConsistencyTest extends SetupVerificationTest {
	...
	void inconsistentVerificationCardSetIds() {
		...
		final VerifyVerificationCardSetsConsistency verifyVerificationCardSetsConsistency = new VerifyVerificationCardSetsConsistency(pathServiceMock,
				applicationEventPublisherMock, electionDataExtractionService);

		final VerificationResult result = verifyVerificationCardSetsConsistency.verify(datasetPath);
