...
import ch.post.it.evoting.verifier.backend.verifications.tally.evidence.algorithms.VerifyOnlineControlComponentsBallotBoxAlgorithm;

@DisplayName("VerifyOnlineControlComponents with")
class VerifyOnlineControlComponentsTest extends TallyVerificationTest {
	...
	static void setUpAll() {
		...
		verifyOnlineControlComponentsAlgorithm = spy(
				new VerifyOnlineControlComponentsAlgorithm(electionDataExtractionService, verifyOnlineControlComponentsBallotBoxAlgorithm));
	...
	void algorithmReturningFalse() {
		doReturn(false).when(verifyOnlineControlComponentsAlgorithm).verifyOnlineControlComponents(any(), any(), anyList());
