...
class VerifyTallyControlComponentTest extends TallyVerificationTest {
	...
	private static final GetWriteInEncodedVotingOptionsAlgorithm GET_WRITE_IN_ENCODED_VOTING_OPTIONS_ALGORITHM = new GetWriteInEncodedVotingOptionsAlgorithm();
	private static final GetPsiAlgorithm GET_PSI_ALGORITHM = new GetPsiAlgorithm(new GetBlankCorrectnessInformationAlgorithm());
	private static final GetDeltaHatAlgorithm GET_DELTA_HAT_ALGORITHM = new GetDeltaHatAlgorithm(GET_WRITE_IN_ENCODED_VOTING_OPTIONS_ALGORITHM);
	...
	private static final ProcessPlaintextsAlgorithm PROCESS_PLAINTEXTS_ALGORITHM = new ProcessPlaintextsAlgorithm(ElGamalFactory.createElGamal(),
			new FactorizeAlgorithm(), DECODE_WRITE_INS_ALGORITHM, GET_ENCODED_VOTING_OPTIONS_ALGORITHM, GET_ACTUAL_VOTING_OPTIONS_ALGORITHM,
			GET_WRITE_IN_ENCODED_VOTING_OPTIONS_ALGORITHM, GET_PSI_ALGORITHM, GET_DELTA_HAT_ALGORITHM);
	...
	private static final VerifyTallyControlComponentBallotBoxAlgorithm VERIFY_TALLY_CONTROL_COMPONENT_BALLOT_BOX_ALGORITHM = new VerifyTallyControlComponentBallotBoxAlgorithm(
			MixnetFactory.createMixnet(), GET_PSI_ALGORITHM, GET_DELTA_HAT_ALGORITHM, ZeroKnowledgeProofFactory.createZeroKnowledgeProof(),
			GET_ENCODED_VOTING_OPTIONS_ALGORITHM, VERIFY_PROCESS_PLAINTEXTS_ALGORITHM);
