 ...
 */
package ch.post.it.evoting.verifier.backend.verifications.setup.evidence.verifications;
...
import ch.post.it.evoting.verifier.backend.verifications.setup.evidence.ExponentiationProofsVerificationExtractionService;
import ch.post.it.evoting.verifier.backend.verifications.setup.evidence.algorithms.VerifyEncryptedPCCExponentiationProofsAlgorithm;
import ch.post.it.evoting.verifier.backend.verifications.setup.evidence.algorithms.VerifyEncryptedPCCExponentiationProofsVerificationCardSetAlgorithm;

@DisplayName("VerifyEncryptedPCCExponentiationProofs with")
class VerifyEncryptedPCCExponentiationProofsTest extends SetupVerificationTest {

	private static VerifyEncryptedPCCExponentiationProofsVerificationCardSetAlgorithm verifyPCCProofsVerificationCardSetAlgorithm;

	@BeforeAll
	static void setUpAll() {
		verifyPCCProofsVerificationCardSetAlgorithm = spy(new VerifyEncryptedPCCExponentiationProofsVerificationCardSetAlgorithm(
	...
	void algorithmReturningFalse() {
		doReturn(false).when(verifyPCCProofsVerificationCardSetAlgorithm).verifyEncryptedPCCExponentiationProofsVerificationCardSet(any(), any());
