...
import {errorStack, isDefault, isError, isNotOK, isOK, isRunning, showErrorStack} from "../../utils/verification-utils";
...
export class VerificationDetailsComponent {
  ...
  protected readonly isNotOK = isNotOK;
  protected readonly showErrorStack = showErrorStack;
  protected readonly isOK = isOK;
  protected readonly isRunning = isRunning;
  protected readonly isDefault = isDefault;
  protected readonly errorStack = errorStack;
